...
(function()
{
	...
	freeboard.loadDatasourcePlugin({
		...
		"type_name"   : "my_datasource_pluginMe",
		// **display_name** : The pretty name that will be used for display purposes for this plugin. If the name is not defined, type_name will be used instead.
		"display_name": "Mi Plugin Ejemplo",
	...
	var myDatasourcePlugin = function(settings, updateCallback)
	{
		...
		function getData()
		{
			...
			/*$.ajax({
			  url: "http://192.168.107.10:5984/trans_log/_design/consulta_logs/_view/consultaLogsTiempoIndividual",
			  success: function(datos){
			  	var arr=[];
			  	for(var i=0;i<datos.length;i++)
			  		arr.push(datos[i].timestamp);
			  	var newData = { data : arr }; // Just putting some sample data in for fun.
			  ...
			  dataType: dataType
			  	...
			  	var newData = { resultado : 'reee' }; // Just putting some sample data in for fun.
