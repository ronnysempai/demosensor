...
(function()
{
	...
	var myDatasourcePlugin = function(settings, updateCallback)
	{
		...
		function getData()
		{
			...
			$.ajax({
			  url: "http://181.196.251.21:5984/trans_log/_design/consulta_logs/_view/consultaLogsTiempoIndividual",
			  success: function(datos){
			  	var arr=[];
			  	for(var i=0;i<datos.rows.length;i++)
			  		arr.push(datos.rows[i].value);
			  	console.log(datos);
			...
			//console.log(currentSettings.last_name[0]);
		}
